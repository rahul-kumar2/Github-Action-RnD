...
namespace com.maersk.orderhandling.containermain
{
	...
	public partial class stuffedVolumeVolumeUnit : ISpecificRecord
	{
		public static Schema _SCHEMA = Avro.Schema.Parse(@"{""type"":""record"",""name"":""stuffedVolumeVolumeUnit"",""namespace"":""com.maersk.orderhandling.containermain"",""fields"":[{""name"":""unitOfMeasurementCode"",""doc"":""The measurement code - E.g.: Litre, Gallon, Cubic Metres."",""type"":""string""},{""name"":""unitOfMeasurementName"",""doc"":""The full name of the measurement unit."",""type"":""string""},{""name"":""measurementSystem"",""doc"":""Indicator for the measurement system used."",""type"":{""type"":""record"",""name"":""measurementSystem"",""namespace"":""com.maersk.orderhandling.containermain"",""fields"":[{""name"":""measurementSystemCode"",""doc"":""The abbreviated measure system name. - E.g.: S.I. (Metric), Imperial, US Customary Units, Time, Industry Standard."",""type"":""string""},{""name"":""measurementSystemName"",""doc"":""The full measure system name."",""type"":""string""}]}}]}");
		/// <summary>
		/// The measurement code - E.g.: Litre, Gallon, Cubic Metres.
		/// </summary>
		...
		public virtual Schema Schema
		{
			get
			{
				return stuffedVolumeVolumeUnit._SCHEMA;
			}
		}
		/// <summary>
		/// The measurement code - E.g.: Litre, Gallon, Cubic Metres.
