...
namespace com.maersk.orderhandling.containermain
{
	...
	public partial class equipmentTypeChildEquipmentType : ISpecificRecord
	{
		...
		/// <summary>
		/// Subtype description of the container type. This is lower level of the recursion level 1.
		/// </summary>
		private com.maersk.orderhandling.containermain.equipmentTypeChildEquipmentTypeL1 _equipmentTypeChildEquipmentTypeL1;
		public virtual Schema Schema
		{
			get
			{
				return equipmentTypeChildEquipmentType._SCHEMA;
			}
		}
		/// <summary>
		/// The Maersk code for equipment type.
		...
		/// Subtype description of the container type. This is lower level of the recursion level 1.
		/// </summary>
		public com.maersk.orderhandling.containermain.equipmentTypeChildEquipmentTypeL1 equipmentTypeChildEquipmentTypeL1
		{
			get
			{
				return this._equipmentTypeChildEquipmentTypeL1;
			}
			set
			{
				this._equipmentTypeChildEquipmentTypeL1 = value;
			}
		}
		public virtual object Get(int fieldPos)
		{
			...
			case 2: return this.equipmentTypeChildEquipmentTypeL1;
		...
		public virtual void Put(int fieldPos, object fieldValue)
		{
			...
			case 2: this.equipmentTypeChildEquipmentTypeL1 = (com.maersk.orderhandling.containermain.equipmentTypeChildEquipmentTypeL1)fieldValue; break;
