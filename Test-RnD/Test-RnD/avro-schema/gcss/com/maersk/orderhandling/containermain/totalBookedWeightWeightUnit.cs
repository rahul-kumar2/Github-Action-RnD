...
namespace com.maersk.orderhandling.containermain
{
	...
	public partial class totalBookedWeightWeightUnit : ISpecificRecord
	{
		...
		public virtual Schema Schema
		{
			get
			{
				return totalBookedWeightWeightUnit._SCHEMA;
			}
		}
		/// <summary>
		/// The measurement code - E.g.: KGS, Metric Ton, US LBS.
